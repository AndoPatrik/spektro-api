...
{
    public class ReservationModelExtended
    {
        ...
        public ReservationModelExtended() { }

        public ReservationModelExtended(string firstName, string lastName, string emailAddress, string phoneNumber, bool emailNotifcation, bool smsNotification, int noOfPeople, DateTime dateOfReservation, int Id)
        {
